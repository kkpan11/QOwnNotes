...
- <kbd>Ctrl</kbd> + <kbd>F</kbd> 현재 노트에서 검색할 수 있습니다
  - <kbd>Up</kbd> 및  <kbd>Down</kbd>  키 또는 <kbd>F3</kbd> 및 <kbd>⇧ Shift</kbd> + <kbd>F3</kbd> 키를 사용하여 이전 및 다음 일치로 이동합니다
  - <kbd>Esc</kbd>로 검색 표시줄을 닫습니다
...
- <kbd>Down</kbd> 또는 <kbd>Tab</kbd> 노트 목록에 집중을 설정합니다
- <kbd>Return</kbd>은 검색창의 텍스트를 표제로 하여 새 노트를 만듭니다
...
- <kbd>Tab</kbd> 선택한 텍스트를 들여쓰기합니다 (여러 줄에서도 작동)
  - <kbd>⇧ Shift</kbd> + <kbd>Tab</kbd> 선택한 텍스트의 들여쓰기를 해제합니다
- 순서 없는 목록 문자 뒤에 <kbd>Tab</kbd>을 누르면 목록 항목이 들여쓰기됩니다
  - 순서 없는 목록 문자 뒤에 <kbd>⇧ Shift</kbd> + <kbd>Tab</kbd>을 누르면 목록 항목의 들여쓰기가 해제됩니다
- 목록에서 <kbd>Return</kbd>을 누르면 새 목록 항목이 생성됩니다
