...
![Navigateur de l’application Web QOwnNotes](/img/blog/web-application-browser.png "Envoyez des photos depuis votre téléphone mobile vers QOwnNotes sur l'application de bureau")
...
La page **Application Web** des préférences permet d’activer la prise en charge de l’application web.

![Préférences de l'application Web QOwnNotes](/img/blog/web-application-settings.png "Configurez la communication avec l'application Web")

N'oubliez pas de **copier votre jeton secret** depuis la page des préférences de QOwnNotes vers [app.qownnotes.org](https://app.qownnotes.org/) pour pouvoir communiquer avec votre instance locale de QOwnNotes. Vous pouvez également scanner le jeton à partir du code QR avec votre téléphone dans l'application Web.
