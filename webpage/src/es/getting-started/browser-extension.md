...
Para la integración de [Homepage](https://github.com/gethomepage/homepage) con las sugerencias de marcadores de QOwnNotes, consulte la [API de sugerencias de página de inicio](./homepage-suggestion-api.md).
